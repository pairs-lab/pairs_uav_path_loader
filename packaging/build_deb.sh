...
# dependency .debs from /prebuilt, then builds pairs_uav_path_loader and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_uav_path_loader/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_uav_path_loader
